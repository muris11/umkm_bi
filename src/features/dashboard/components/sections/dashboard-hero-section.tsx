    ...
    >
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          >
            <Badge variant="info" className="bg-brand-teal/10 text-brand-teal border-brand-teal/20 backdrop-blur-sm">
              Jawa Barat 2025
            </Badge>
          </motion.div>
          <h1 className="text-3xl md:text-4xl font-bold font-grotesk text-slate-900 tracking-tight">
        ...
        <motion.div 
          ...
          className="flex flex-wrap items-center gap-3 text-sm text-slate-500 bg-white/50 p-4 rounded-xl border border-white/60 shadow-sm backdrop-blur-md"
        >
            <div className="flex flex-col">
               <span className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Sumber Data</span>
               <span className="font-medium text-slate-700">{meta.sumber}</span>
            </div>
            ...
            <div className="flex flex-col">
               ...
               <span className="font-medium text-slate-700">{new Date(meta.generatedAt).toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' })}</span>
            </div>
        </motion.div>
      </div>
    </motion.header>
