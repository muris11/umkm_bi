...
export function DashboardContainer({ rawData, meta }: DashboardContainerProps) {
  ...
  return (
    <DashboardLayout>
      ...
      <MLPlaygroundSection rawData={rawData} viewModel={viewModel} />

      <BIDashboardSection roleBasedData={viewModel.biDashboard.roleBasedData} />

      <BIBuilderSection viewModel={viewModel} rawData={rawData} />

      <DashboardBiVisualizationSection data={viewModel} />

      <DashboardInsightSection insights={viewModel.insights} />

      <DataDrivenDecisionEnhancedSection decision={viewModel.dataDrivenDecision} />

      <WhatIfSimulatorSection viewModel={viewModel} />

      <DataExplorerSection data={viewModel.filteredData} />
      ...
      <div className="mb-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div>
          <DashboardDssSection
            alternatives={viewModel.topKecamatan.map((k, i) => ({
              ...k,
              id: k.kecamatan,
